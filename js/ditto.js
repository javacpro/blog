...
function searchbar_listener(event) {
    ...
    if (q !== '') {
      var url = 'https://github.com/javacpro/blog/search?utf8=✓&q=' + encodeURIComponent(q);
